          ...
          <div className="flex-1 flex flex-col">
            ...
            <header className="bg-gray-100 border-b p-4 flex justify-between items-center">
              ...
              <div className="space-x-4">
                <Link href="/user/signin" className="text-blue-600 hover:underline">Logowanie</Link>
                <Link href="/user/register" className="text-blue-600 hover:underline">Rejestracja</Link>
              </div>
            </header>
